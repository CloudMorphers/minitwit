...
# Remove init_db() because your .NET app does not use it
...
if __name__ == "__main__":
    ...
    try:
        test_latest()
        print("✅ test_latest() passed")

        test_register()
        print("✅ test_register() passed")

        test_create_msg()
        print("✅ test_create_msg() passed")

        test_get_latest_user_msgs()
        print("✅ test_get_latest_user_msgs() passed")

        test_get_latest_msgs()
        print("✅ test_get_latest_msgs() passed")

        test_register_b()
        print("✅ test_register_b() passed")

        test_register_c()
        print("✅ test_register_c() passed")

        test_follow_user()
        print("✅ test_follow_user() passed")

        test_a_unfollows_b()
        print("✅ test_a_unfollows_b() passed")
